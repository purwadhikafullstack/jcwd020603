...
const salesReportUserController = {
    ...
    console.log(formattedOutput, "ini data user berdasarkan tanggal transaksinya");

    res.status(200).send({ message: "User Transaction Summary", allData : userTransactionDetails , dataTransByDate: formattedOutput });
  } catch (error) {
    ...
    console.log(formattedOutput, "ini data user berdasarkan tanggal transaksinya cuuy");
