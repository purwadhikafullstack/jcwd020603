...
useEffect(() => {
 ...
 getSalesReportProduct()
  ...
  return(
      ...
      <>
      <Flex flexDir={"column"} >
      <Flex flexDir={"row"} justifyContent={"center"} mt={"50px"} mb={"20px"} fontWeight={"extrabold"} fontSize={{base: "15px" , sm:"18px", md:"20px", lg: "30px"}}>
      ...
      <Flex  gap={"10%"} w={"100%"} h={"auto"} alignItems={{base : "center", sm: "center"}} flexDir={"column"} >
       <Flex gap={"15px"} alignItems={{base : "center", sm: "center"}} justifyContent={"space-evenly"} flexDir={{base : "column", sm: "column", md: "row", lg: "row"}} w={"80%"}>
