...
export default function SalesReportProduct() {
  ...
  const cariBestSeller = () => {
    ...
    const objTotalTertinggi = dtSumQtyProd.find(
      (item) => parseInt(item.total_qty) === totalTertinggi
    );
    const bestSellernya = {
  ...
  return (
    <>
      ...
      <Flex className="flex1R-salesReportTrans">
        {/* =========================================================== */}
        <SalesReportProductContent
          dtSumQtyProdPagination={dtSumQtyProdPagination}
          setDtSumQtyProdPagination={setDtSumQtyProdPagination}
          dtSumQtyProd={dtSumQtyProd}
          setDtSumQtyProd={setDtSumQtyProd}
          searchRef={searchRef}
          ...
          date={date}
          setDate={setDate}
          total_terjualBestSeller={total_terjualBestSeller}
          inputHandler={inputHandler}
          inputHandlerBranch_name={inputHandlerBranch_name}
          pageHandler={pageHandler}
          formatCurrency={formatCurrency}
          product_nameBestSeller={product_nameBestSeller}
        />
        {/* ============================================================ */}
      </Flex>
    </>
