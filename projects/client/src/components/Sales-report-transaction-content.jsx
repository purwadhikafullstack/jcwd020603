          ...
          >
            <Thead w={"100%"} bg={"#ffb21c"} fontSize={"12px"}>
              <Tr>
                ...
                {ascModeDate ? <MdArrowBackIosNew size={"15%"} id="descendingB"/> : 
                ...
                }}><Flex w={"100%"} gap={"15%"} alignItems={"center"}>Total Harga
                {ascModePrice ? <MdArrowBackIosNew id="descendingB" size={"15%"}/> : 
                <MdArrowBackIosNew id="ascendingB" size={"15%"}/>}</Flex></Th>
              </Tr>
            </Thead>
