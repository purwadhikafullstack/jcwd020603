  ...
  return (
    <>
      ...
      <Flex className="flex1R-disvoc">
        <Flex className="flex2R-disvoc">Pengaturan Voucher</Flex>
        ...
        <Grid className="gridMenuG" flexDir={"row"}>
          <Flex className="menuTotalG">
            ...
            <Flex flexDir={"column"}>
              <Flex className="flex3R-disvoc">{dtVocer?.length}</Flex>
          ...
          <Flex className="menuTotalG">
            ...
            <Flex flexDir={"column"}>
              <Flex className="flex3R-disvoc">{userSelector.branch_id}</Flex>
              <Flex color={"grey"} fontWeight={"semibold"}>
                Cabang ID
              </Flex>
            </Flex>
