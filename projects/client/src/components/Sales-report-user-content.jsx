    ...
    return(
        ...
        <Flex flexDir={"column"} rowGap={"10px"}>
          ...
          <Flex overflowX={"auto"} w={"100%"} mt={5} mb={10} flexDir={"column"} fontWeight={'extrabold'}>
            ...
            <ChartSalesReportUser dtSumQtyUser={dtSumQtyUser} dtSumQtyUserAll={dtSumQtyUserAll}/>
          </Flex>
          {/* chart */}
          {/* table */}
          ...
          <Table
            ...
            <Thead w={"100%"} bg={"#ffb21c"} fontSize={"14px"}>
              <Tr>
                ...
                }}><Flex w={"100px"}><Flex w={"70%"}>Tanggal</Flex>
              ...
              {dtSumQtyUserPagination?.map((val, index) => (
                <Tr key={index} className="table-row">
                  ...
                  <Td onClick={() => {
                    onOpen()
                    setIndexnya(index)
                  }} cursor={"pointer"}><IoReorderThreeSharp /></Td>
                </Tr>
              ))}
            </Tbody>
          </Table>
